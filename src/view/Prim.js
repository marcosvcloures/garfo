...
class Modal extends React.Component {
    ...
    render() {
        return <div className="modal" id="modalPrim">
            <div className="modal-content">
                <h4>Escolha o vértice inicial</h4>
                <div className="row">
                    <h6>O algoritmo de Prim precisa de um vértice inicial!<br />
...
const Step = () => {
    ...
    if (present.vars.source !== null) {
        ...
        for (let e of adjList[atual.id])
            if (!visited[e.to])
                queue.push({ id: e.to, cost: e.cost, edge: e.id })
