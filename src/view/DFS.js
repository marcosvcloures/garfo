...
class Modal extends React.Component {
    ...
    render() {
        return <div className="modal" id="modalDFS">
            <div className="modal-content">
                <h4>Escolha o vértice inicial</h4>
                <div className="row">
                    <h6>A busca em profundidade precisa de um vértice inicial!<br />
...
const Step = () => {
    ...
    if (present.vars.source !== null) {
        ...
        for (let e of adjList[atual.id])
            if (!visited[e.to])
                queue = [{ id: e.to, cost: 1, edge: e.id }, ...queue]
